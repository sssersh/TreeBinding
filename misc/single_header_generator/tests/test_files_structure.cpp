...
class files_structure_test : public ::testing::Test
{
public:
    void SetUp() override
    {
        fs::create_directories(root_dir / input_dir_name / project_name / input_file2_path.parent_path());
        std::ofstream {root_dir / input_dir_name / project_name / main_file_name};
        std::ofstream {root_dir / input_dir_name / project_name / input_file1_path};
        std::ofstream {root_dir / input_dir_name / project_name / input_file2_path};
    ...
    files_structure_t create_file_structure()
    {
        return
            {
                  root_dir
...
TEST_F(files_structure_test, base)
{
    fs::remove_all(root_dir);
...
TEST_F(files_structure_test, prepare_out_dir_and_file)
{
...
TEST_F(files_structure_test, read_src_files)
{
